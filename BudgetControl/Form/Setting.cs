...
namespace BudgetControl
{
    public partial class Setting : Form
    {
        ...
        public Setting()
        {
            ...
            textBox5.Text=Properties.Settings.Default.sapLicenseServer;
        }
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please Type SAP License Server");
            }
            ...
            else
            {
                ...
                Properties.Settings.Default.sapLicenseServer = textBox5.Text;
